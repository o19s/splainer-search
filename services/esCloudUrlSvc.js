...
angular.module('o19s.splainer-search')
  .service('esCloudUrlSvc', [
    function esCloudUrlSvc() {
      ...
      function getHeaders (uri, apiKey) {
        var headers = {};

        if ( angular.isDefined(apiKey) && uri.apiKey !== '') {
          var authorization = apiKey;
          headers = { 'Authorization': 'ApiKey ' + authorization };
        }
