...
(function() {
  angular.module('o19s.splainer-search')
    .factory('EsCloudSearcherFactory', [
      '$http',
      '$q',
      '$log',
      'EsDocFactory',
  ...
  function EsCloudSearcherFactory(
    $http, $q, $log,
    EsDocFactory,
    activeQueries,
    esCloudSearcherPreprocessorSvc, esCloudUrlSvc,
    SearcherFactory,
    transportSvc
  ) {

    var Searcher = function(options) {
      SearcherFactory.call(this, options, esCloudSearcherPreprocessorSvc);
    };
    ...
    function search () {
      ...
      //esCloudUrlSvc.setParams(uri, self.pagerArgs);

      var headers = esCloudUrlSvc.getHeaders(uri, apiKey);
    ...
    function explain(doc) {
      ...
      var self    = this;
      var uri     = esCloudUrlSvc.parseUrl(self.url);
      var url     = esCloudUrlSvc.buildExplainUrl(uri, doc);
      var apiKey  = self.apiKey;
      var headers = esCloudUrlSvc.getHeaders(uri, apiKey);
    ...
    function isTemplateCall() {
      ...
      return esCloudUrlSvc.isTemplateCall(esCloudUrlSvc.parseUrl(self.url));
    }
