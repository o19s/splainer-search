...
describe('Service: searchSvc: OpenSearch', function() {
  ...
  var mockOsUrl     = 'http://localhost:8000/statedecoded/opensearch';
  ...
  var mockOsResults = {
  	...
  	"_links": {
  		...
  		"alternate": {
  			"href": "http://localhost:8000/statedecoded/opensearch?q=test",
  			"type": "text/html"
  		},
  		"self": {
  			"href": "http://localhost:8000/statedecoded/opensearch?q=test&start=1"
  		},
  		"first": {
  			"href": "http://localhost:8000/statedecoded/opensearch?q=test&start=1"
  		},
  		"next": {
  			"href": "http://localhost:8000/statedecoded/opensearch?q=test&start=2"
  		},
  		"search": {
  			"href": "http://localhost:8000/statedecoded/opensearchdescription.xml",
  	...
  	"_embedded": {
          ...
          "id": "https://www.hudexchange.info/programs/multifamily-housing/financial-management-toolkit/9-basics-of-cost-allocation/9d-the-radar-test/",
  				...
  				"_links": {
  					"self": {
  						"href": "https://www.hudexchange.info/programs/multifamily-housing/financial-management-toolkit/9-basics-of-cost-allocation/9d-the-radar-test/",
  						"type": "text/html"
  					}
  				}
  			},
          ...
          "id": "https://www.hudexchange.info/news/the-origin-year-expenditure-test-webinar/",
  				...
  				"_links": {
  					"self": {
  						"href": "https://www.hudexchange.info/news/the-origin-year-expenditure-test-webinar/",
  						"type": "text/html"
  					}
  				}
  			}
  ...
  describe('version OS', function() {
    ...
    it('returns docs, and maps the hits.total.value to the numFound', function() {
      $httpBackend.expectGET(mockOsUrl).
      respond(200, mockOsResults);
