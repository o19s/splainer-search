...
describe('searchSvc: Algolia', () => {
  ...
  var mockAlgoliaResults = {
    ...
    timeoutCounts: false,
    timeoutHits: false,
    aiReRanking: { reRankingActivated: true, persoImpactInsideActivationWindow: false },
    appliedRules: [
  ...
  describe('paging', () => {
    ...
    it('accounts for custom hitsPerPage in args', async () => {
    ...
    it('returns null when the first response is already the only page', async () => {
    ...
    it('advances from a non-zero starting page in args', async () => {
    ...
    it('keeps attributesToHighlight on the paged request body', async () => {
  ...
  it('getTransportParameters uses multi-get objects URL and results key when retrieving objects', () => {
    var searcher = searchSvc.createSearcher(
      mockFieldSpec,
      mockAlgoliaUrl,
