...
describe('solrUrlSvc', () => {
  ...
  describe('parse URL', () => {
    ...
    it('doesnt warn on group arguments', () => {
      var solrUrlSvc = createSolrUrlSvc();
      var urlStr =
        'http://localhost:8983/solr/collection1/select?group=true&group.main=true&group.field=text&q=*:*';
      var parsedSolrUrl = solrUrlSvc.parseSolrUrl(urlStr);
  ...
  describe('build URL', () => {
    ...
    it('does not re-escape escaped values inside double quotes', () => {
      ...
      expect(url).toEqual(
        'http://localhost:8080/solr/index/select?q=*:*&bq=(*:* AND -meta_contentType_ms:"Faculty%20%26%20Research%20Work")^100&p=50%25&p1="Faculty%20%26%20Research%20Work"',
      );
      ...
      expect(url).toEqual(
        'http://localhost:8080/solr/index/select?q=*:*&bq=(*:* AND -meta_contentType_ms:"Faculty %26 Research Work")^100&p=50%25&p1="Faculty %26 Research Work"',
      );
    });
  });
